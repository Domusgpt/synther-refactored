...
');
        ...
        if (suggestions.isNotEmpty)
          Wrap(
            ...
            children: suggestions.map((suggestion) {
              ...
              final backgroundColor = isPrimed
                  ? colorScheme.primary.withOpacity(0.18)
                  : const Color(0xFF1A1D39);
              final labelColor =
                  isPrimed ? colorScheme.primary : Colors.white;
              ...
              final chip = ActionChip(
                ...
                label: Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 12,
                    fontWeight:
                        isPrimed ? FontWeight.w600 : FontWeight.w500,
                  ),
                ),
  ...
  void _primeSuggestion(ModulationRouteSuggestion suggestion) {
    setState(() {
