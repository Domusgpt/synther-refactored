...
class AudioEngine extends ChangeNotifier {
  AudioEngine({
    ...
    _parameterSetters =
      ...
      'macro1': (value, {notify = true}) =>
          setMacro1(value, notify: notify),
      'macro2': (value, {notify = true}) =>
          setMacro2(value, notify: notify),
      'macro3': (value, {notify = true}) =>
          setMacro3(value, notify: notify),
      'macro4': (value, {notify = true}) =>
          setMacro4(value, notify: notify),
  ...
  double _macro1 = _parameterRegistry.defaultValue('macro1') ?? 0.0;
  double _macro2 = _parameterRegistry.defaultValue('macro2') ?? 0.0;
  double _macro3 = _parameterRegistry.defaultValue('macro3') ?? 0.0;
  double _macro4 = _parameterRegistry.defaultValue('macro4') ?? 0.0;
  ...
  double get macro1 => _macro1;
  double get macro2 => _macro2;
  double get macro3 => _macro3;
  double get macro4 => _macro4;
  ...
  Future<void> setMacro1(double value, {bool notify = true}) async {
    await _updateParameter(
      value: value,
      range: _parameterRegistry.descriptorFor('macro1')!.range,
      current: _macro1,
      parameterId: SynthParameterId.macro1,
      bridgeParameterName: 'macro1',
      assign: (v) => _macro1 = v,
      notify: notify,
    );
  }

  Future<void> setMacro2(double value, {bool notify = true}) async {
    await _updateParameter(
      value: value,
      range: _parameterRegistry.descriptorFor('macro2')!.range,
      current: _macro2,
      parameterId: SynthParameterId.macro2,
      bridgeParameterName: 'macro2',
      assign: (v) => _macro2 = v,
      notify: notify,
    );
  }

  Future<void> setMacro3(double value, {bool notify = true}) async {
    await _updateParameter(
      value: value,
      range: _parameterRegistry.descriptorFor('macro3')!.range,
      current: _macro3,
      parameterId: SynthParameterId.macro3,
      bridgeParameterName: 'macro3',
      assign: (v) => _macro3 = v,
      notify: notify,
    );
  }

  Future<void> setMacro4(double value, {bool notify = true}) async {
    await _updateParameter(
      value: value,
      range: _parameterRegistry.descriptorFor('macro4')!.range,
      current: _macro4,
      parameterId: SynthParameterId.macro4,
      bridgeParameterName: 'macro4',
      assign: (v) => _macro4 = v,
      notify: notify,
    );
  }
  ...
  Map<String, double> getVisualizerData() {
    ...
    data['macro3'] = _macro3;
    data['macro4'] = _macro4;
    final macroAverage = (_macro1 + _macro2 + _macro3 + _macro4) / 4.0;
    data['macroAverage'] = macroAverage;
    data['performanceEnergy'] =
        (_modWheel + _channelAftertouch + _expression + macroAverage) / 4.0;
  ...
  void _pushStateToBackend() {
    ...
    _backend.setParameter(SynthParameterId.macro1, _macro1);
    _backend.setParameter(SynthParameterId.macro2, _macro2);
    _backend.setParameter(SynthParameterId.macro3, _macro3);
    _backend.setParameter(SynthParameterId.macro4, _macro4);
