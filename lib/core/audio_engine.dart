...
class AudioEngine extends ChangeNotifier {
  ...
  static const Map<String, List<String>> _bridgeParameterAliases = {
    ...
    'maxPolyphony': <String>['polyphony', 'voices'],
  };

  static const List<String> _canonicalParameterNames = <String>[
    'masterVolume',
    'filterCutoff',
    'filterResonance',
    'attackTime',
  ...
  static const Map<String, List<String>> _presetExtractionCandidates =
      <String, List<String>>{
    'masterVolume': <String>[
      'mastervolume',
      'volume',
  ...
  static final Map<String, String> _parameterLookup = _buildParameterLookup();
  ...
  void setMaxPolyphony(int value, {bool notify = true}) {
    ...
    final released = _voiceAllocator.updateMaxVoices(value);
  ...
  Map<String, double> _collectState({bool includeAliases = true}) {
    ...
    for (final entry in _bridgeParameterAliases.entries) {
  ...
  Map<String, double> _extractPresetValues(Map<String, dynamic> preset) {
    ...
    for (final canonical in _canonicalParameterNames) {
      final candidates = _presetExtractionCandidates[canonical];
      if (candidates == null) {
        continue;
      }

      for (final candidate in candidates) {
        final value = flattened[candidate];
        if (value != null) {
    ...
    flattened.forEach((key, value) {
      final canonical = _parameterLookup[key];
      if (canonical == null) {
        return;
      }
      extracted.putIfAbsent(canonical, () => value);
    });
  ...
  static Map<String, double> _flattenPresetValues(
    ...
    void visit(dynamic value, String path) {
      ...
      final key = _normaliseLookupKey(path);
      if (key.isEmpty) {
        return;
      }
  ...
  static String _canonicalParameterNameFor(String name) {
    final canonical =
        _parameterLookup[_normaliseLookupKey(name)] ?? _parameterLookup[name];
    return canonical ?? name;
  }

  static Map<String, String> _buildParameterLookup() {
    final map = <String, String>{};

    void register(String alias, String canonical) {
      map[_normaliseLookupKey(alias)] = canonical;
    }
    ...
    _bridgeParameterAliases.forEach((canonical, aliases) {
      for (final alias in aliases) {
    ...
    const additional = <String, String>{
      ...
      'volume': 'masterVolume',
      'amplevel': 'masterVolume',
      'ampvolume': 'masterVolume',
      'amp': 'masterVolume',
      'outputvolume': 'masterVolume',
      'filtercutoff': 'filterCutoff',
      'filtercut': 'filterCutoff',
      'filterfrequency': 'filterCutoff',
      'filterfreq': 'filterCutoff',
      'cutoff': 'filterCutoff',
      'cutoffhz': 'filterCutoff',
      'filterhz': 'filterCutoff',
      'filtercutoffhz': 'filterCutoff',
      'filterresonance': 'filterResonance',
      'resonance': 'filterResonance',
      'res': 'filterResonance',
      'filterres': 'filterResonance',
      'filterq': 'filterResonance',
      'q': 'filterResonance',
      'attacktime': 'attackTime',
      'attack': 'attackTime',
      'envelopeattack': 'attackTime',
      'envelopeattacktime': 'attackTime',
      'adsrattack': 'attackTime',
      'adsrattacktime': 'attackTime',
      'envattack': 'attackTime',
      'decaytime': 'decayTime',
      'decay': 'decayTime',
      'envelopedecay': 'decayTime',
      'envelopedecaytime': 'decayTime',
      'adsrdecay': 'decayTime',
      'adsrdecaytime': 'decayTime',
      'envdecay': 'decayTime',
      'sustainlevel': 'sustainLevel',
      'sustain': 'sustainLevel',
      'envelopesustain': 'sustainLevel',
      'envelopesustainlevel': 'sustainLevel',
      'adsrsustain': 'sustainLevel',
      'adsrsustainlevel': 'sustainLevel',
      'envsustain': 'sustainLevel',
      'releasetime': 'releaseTime',
      'release': 'releaseTime',
      'enveloperelease': 'releaseTime',
      'envelopereleasetime': 'releaseTime',
      'adsrrelease': 'releaseTime',
      'adsrreleasetime': 'releaseTime',
      'envrelease': 'releaseTime',
      'reverbmix': 'reverbMix',
      'reverb': 'reverbMix',
      'fxreverb': 'reverbMix',
      'effectsreverbmix': 'reverbMix',
      'delaytime': 'delayTime',
      'delay': 'delayTime',
      'fxdelaytime': 'delayTime',
      'effectsdelaytime': 'delayTime',
      'delayfeedback': 'delayFeedback',
      'feedback': 'delayFeedback',
      'delayfb': 'delayFeedback',
      'fxdelayfeedback': 'delayFeedback',
      'effectsdelayfeedback': 'delayFeedback',
    };

    additional.forEach(register);

    return map;
  }

  static String _normaliseLookupKey(String key) {
