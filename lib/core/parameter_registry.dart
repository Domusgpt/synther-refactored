  ...
  ParameterRegistry._() {
    ...
    _register(
      ParameterDescriptor(
        ...
        visualizerTarget: 'macro1',
        bridgeAliases: const <String>['macroOne', 'macroA', 'macro1Amount'],
        extractionHints: const <String>[
          'macro1',
          'macro_1',
          'macroone',
    ...
    _register(
      ParameterDescriptor(
        ...
        visualizerTarget: 'macro2',
        bridgeAliases: const <String>['macroTwo', 'macroB', 'macro2Amount'],
        extractionHints: const <String>[
          'macro2',
          'macro_2',
          'macrotwo',
    ...
    _register(
      ParameterDescriptor(
        ...
        visualizerTarget: 'macro3',
        bridgeAliases: const <String>['macroThree', 'macroC', 'macro3Amount'],
        extractionHints: const <String>[
          'macro3',
          'macro_3',
          'macrothree',
    ...
    _register(
      ParameterDescriptor(
        ...
        visualizerTarget: 'macro4',
        bridgeAliases: const <String>['macroFour', 'macroD', 'macro4Amount'],
        extractionHints: const <String>[
          'macro4',
          'macro_4',
          'macrofour',
