...
class ParameterRegistry {
  ParameterRegistry._() {
    ...
    _register(
      ParameterDescriptor(
        name: 'arpeggiatorEnabled',
        range: const ParameterRange(
          min: 0,
          max: 1,
          defaultValue: 0,
        ),
        visualizerTarget: 'arpeggiatorActive',
        bridgeAliases: const <String>[
          'arpeggiatorActive',
          'arpEnabled',
          'arpActive',
        ],
    ...
    _register(
      ParameterDescriptor(
        ...
        visualizerTarget: 'arpeggiatorRate',
        bridgeAliases: const <String>['arpRate', 'arpeggiatorSpeed'],
        extractionHints: const <String>[
          'arpeggiatorrate',
          'arpeggiator.rate',
          'arp.frequency',
    ...
    _register(
      ParameterDescriptor(
        name: 'arpeggiatorGate',
        range: const ParameterRange(
          min: 0.05,
          max: 1,
          defaultValue: 0.6,
        ),
        visualizerTarget: 'arpeggiatorGate',
        bridgeAliases: const <String>['arpGate', 'gateTime'],
        extractionHints: const <String>[
          'arpeggiatorgate',
          'arpeggiator.gate',
          'arp.gate',
    ...
    _register(
      ParameterDescriptor(
        name: 'arpeggiatorOctaves',
        range: const ParameterRange(
          min: 1,
          max: 4,
          defaultValue: 1,
        ),
        visualizerTarget: 'arpeggiatorOctaves',
        bridgeAliases: const <String>['arpOctaves', 'arpeggiatorRange'],
        extractionHints: const <String>[
          'arpeggiatoroctaves',
          'arpeggiator.range',
          'arp.range',
    ...
    _register(
      ParameterDescriptor(
        name: 'arpeggiatorMode',
        range: const ParameterRange(
          min: 0,
          max: 4,
          defaultValue: 0,
        ),
        visualizerTarget: 'arpeggiatorMode',
        bridgeAliases: const <String>['arpMode', 'arpeggiatorDirection'],
        extractionHints: const <String>[
          'arpeggiatormode',
    ...
    _register(
      ParameterDescriptor(
        ...
        visualizerTarget: 'arpeggiatorPattern',
        bridgeAliases: const <String>['arpPattern', 'arpeggiatorShape'],
        extractionHints: const <String>[
          'arpeggiatorpattern',
          'arpeggiator.pattern',
          'arp.pattern',
    ...
    _register(
      ParameterDescriptor(
        name: 'arpeggiatorSwing',
        range: const ParameterRange(
          min: 0,
          max: 1,
          defaultValue: 0,
        ),
        visualizerTarget: 'arpeggiatorSwing',
        bridgeAliases: const <String>['arpSwing', 'swingAmount'],
        extractionHints: const <String>[
          'arpeggiatorswing',
          'arpeggiator.swing',
          'arp.swing',
    ...
    _register(
      ParameterDescriptor(
        name: 'arpeggiatorLatch',
        range: const ParameterRange(
          min: 0,
          max: 1,
          defaultValue: 0,
        ),
        visualizerTarget: 'arpeggiatorLatch',
        bridgeAliases: const <String>['arpLatch', 'arpeggiatorHold'],
        extractionHints: const <String>[
          'arpeggiatorlatch',
          'arpeggiator.hold',
          'arp.hold',
    ...
    _register(
      ParameterDescriptor(
        name: 'arpeggiatorTempoSync',
        range: const ParameterRange(
          min: 0,
          max: 1,
          defaultValue: 0,
        ),
        visualizerTarget: 'arpeggiatorSync',
        bridgeAliases: const <String>['arpSync', 'arpeggiatorSync'],
        extractionHints: const <String>[
    ...
    _register(
      ParameterDescriptor(
        name: 'arpeggiatorDivision',
        range: ParameterRange(
          min: 0,
          max: (ArpeggiatorDivision.values.length - 1).toDouble(),
          defaultValue: ArpeggiatorDivision.eighth.value.toDouble(),
        ),
        visualizerTarget: 'arpeggiatorDivision',
        bridgeAliases: const <String>['arpDivision', 'arpeggiatorRateDivision'],
        extractionHints: const <String>[
          'arpeggiatordivision',
          'arpeggiator.rateDivision',
          'arp.division',
        ],
      ),
    );
    ...
    _register(
      ParameterDescriptor(
        ...
        visualizerTarget: 'transportTempo',
        bridgeAliases: const <String>['tempo', 'bpm'],
        extractionHints: const <String>[
          'transporttempo',
          'tempo',
          'bpm',
    ...
    _register(
      ParameterDescriptor(
        ...
        visualizerTarget: 'transportRunning',
        bridgeAliases: const <String>['transportPlay', 'transportActive'],
        extractionHints: const <String>[
          'transportrunning',
          'transport.play',
          'transport.active',
    ...
    _register(
      ParameterDescriptor(
        name: 'transportTimeSignatureNumerator',
        range: const ParameterRange(
          min: 1,
          max: 12,
          defaultValue: 4,
        ),
        visualizerTarget: 'transportTimeSignatureNumerator',
        bridgeAliases: const <String>['tsNumerator', 'timeSignatureNumerator'],
        extractionHints: const <String>[
          'transporttimesignaturenumerator',
          'transport.tsNumerator',
          'transport.numerator',
        ],
      ),
    );
    ...
    _register(
      ParameterDescriptor(
        name: 'transportTimeSignatureDenominator',
        range: const ParameterRange(
          min: 1,
          max: 16,
          defaultValue: 4,
        ),
        visualizerTarget: 'transportTimeSignatureDenominator',
        bridgeAliases: const <String>['tsDenominator', 'timeSignatureDenominator'],
        extractionHints: const <String>[
          'transporttimesignaturedenominator',
          'transport.tsDenominator',
