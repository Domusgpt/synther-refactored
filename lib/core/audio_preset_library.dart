...
class AudioPresetLibrary {
  ...
  void ensureBuiltInPresets() {
    ...
    void registerPreset({
      ...
      List<MacroSnapshot> macros = const <MacroSnapshot>[],
    }) {
      ...
      macros: <MacroSnapshot>[
        MacroSnapshot(
          definition: MacroDefinition(
            id: 'glow-pad-brightness',
            name: 'Brightness',
            description: 'Opens the filter while adding a touch of resonance.',
      ...
      macros: <MacroSnapshot>[
        MacroSnapshot(
          definition: MacroDefinition(
            id: 'laser-drive',
            name: 'Drive & Width',
            description: 'Links chorus depth with distortion for punchy builds.',
            assignments: <MacroAssignment>[
              MacroAssignment(
