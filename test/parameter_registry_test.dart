...
void main() {
  ...
  group('ParameterRegistry', () {
    ...
    test('canonicalize resolves aliases and ignores unknown parameters', () {
      ...
      expect(canonical['macro1'], closeTo(1.0, 1e-9));
      expect(canonical['macro2'], closeTo(0.0, 1e-9));
      expect(canonical['macro3'], closeTo(0.2, 1e-9));
      expect(canonical['macro4'], closeTo(1.0, 1e-9));
    ...
    test('expandWithAliases mirrors canonical values to bridge aliases', () {
      ...
      expect(expanded['macro1'], closeTo(0.25, 1e-9));
      expect(expanded['macroOne'], closeTo(0.25, 1e-9));
      expect(expanded['macroA'], closeTo(0.25, 1e-9));
      expect(expanded['macro3'], closeTo(0.6, 1e-9));
      expect(expanded['macroThree'], closeTo(0.6, 1e-9));
      expect(expanded['macroC'], closeTo(0.6, 1e-9));
    ...
    test('defaultValue exposes descriptor defaults', () {
      ...
      expect(registry.defaultValue('macro1'), closeTo(0.0, 1e-9));
      expect(registry.defaultValue('macro4'), closeTo(0.0, 1e-9));
      expect(
