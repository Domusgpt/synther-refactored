...
void main() {
  ...
  group('Parameter bridge integration', () {
    ...
    test('performance controllers clamp and propagate via the bridge', () async {
      ...
      await engine.setMacro1(0.3);
      await engine.setMacro2(0.65);
      await engine.setMacro3(0.15);
      await engine.setMacro4(0.9);
      await pumpEventQueue();
      ...
      expect(bridge.getParameter('macro1'), closeTo(0.3, 1e-9));
      expect(bridge.getParameter('macro2'), closeTo(0.65, 1e-9));
      expect(bridge.getParameter('macro3'), closeTo(0.15, 1e-9));
      expect(bridge.getParameter('macro4'), closeTo(0.9, 1e-9));
      ...
      bridge.updateParameter('macroa', 2.0, ParameterBridge.UpdateSource.ui);
      bridge.updateParameter('macroB', -1.0, ParameterBridge.UpdateSource.ui);
      bridge.updateParameter('macroThree', 0.42, ParameterBridge.UpdateSource.ui);
      bridge.updateParameter('macro4Amount', 0.3, ParameterBridge.UpdateSource.ui);
      await pumpEventQueue();
      ...
      expect(engine.macro1, closeTo(1.0, 1e-9));
      expect(engine.macro2, closeTo(0.0, 1e-9));
      expect(engine.macro3, closeTo(0.42, 1e-9));
      expect(engine.macro4, closeTo(0.3, 1e-9));
      expect(
        backend.getParameter(SynthParameterId.macro1),
        closeTo(1.0, 1e-9),
      );
      expect(
        backend.getParameter(SynthParameterId.macro2),
        closeTo(0.0, 1e-9),
      );
      expect(
        backend.getParameter(SynthParameterId.macro3),
        closeTo(0.42, 1e-9),
      );
      expect(
        backend.getParameter(SynthParameterId.macro4),
        closeTo(0.3, 1e-9),
      );
      ...
      expect(bridge.getParameter('macroOne'), closeTo(1.0, 1e-9));
      expect(bridge.getParameter('macroB'), closeTo(0.0, 1e-9));
      expect(bridge.getParameter('macroThree'), closeTo(0.42, 1e-9));
      expect(bridge.getParameter('macro4Amount'), closeTo(0.3, 1e-9));
  ...
  group('Preset management', () {
    test('capturePreset snapshots current state and aliases', () async {
      ...
      await engine.setMacro1(0.25);
      await engine.setMacro2(0.4);
      await engine.setMacro3(0.55);
      await engine.setMacro4(0.12);
      ...
      expect(preset.parameters['macro1'], closeTo(0.25, 1e-9));
      expect(preset.parameters['macroOne'], closeTo(0.25, 1e-9));
      expect(preset.parameters['macro2'], closeTo(0.4, 1e-9));
      expect(preset.parameters['macroB'], closeTo(0.4, 1e-9));
      expect(preset.parameters['macro3'], closeTo(0.55, 1e-9));
      expect(preset.parameters['macroThree'], closeTo(0.55, 1e-9));
      expect(preset.parameters['macro4'], closeTo(0.12, 1e-9));
      expect(preset.parameters['macroD'], closeTo(0.12, 1e-9));
    ...
    test('applyPreset updates backend, bridge and active preset snapshot', () async {
      ...
      expect(engine.sustainEngaged, isTrue);
      expect(bridge.getParameter('sustain'), closeTo(1.0, 1e-9));
      expect(engine.macro1, closeTo(0.5, 1e-9));
      expect(engine.macro2, closeTo(0.2, 1e-9));
      expect(engine.macro3, closeTo(0.3, 1e-9));
      expect(engine.macro4, closeTo(0.8, 1e-9));
      expect(bridge.getParameter('macroOne'), closeTo(0.5, 1e-9));
      expect(bridge.getParameter('macroB'), closeTo(0.2, 1e-9));
      expect(bridge.getParameter('macroThree'), closeTo(0.3, 1e-9));
      expect(bridge.getParameter('macro4Amount'), closeTo(0.8, 1e-9));
      final visualizer = engine.getVisualizerData();
      ...
      expect(visualizer['macro1'], closeTo(0.5, 1e-9));
      expect(visualizer['macroAverage'], closeTo(0.45, 1e-9));
      expect(
        visualizer['performanceEnergy'],
        closeTo((0.88 + 0.54 + 0.61 + 0.45) / 4, 1e-9),
      );
    ...
    test('loadPreset parses nested alias-heavy preset data', () async {
      ...
      expect(engine.macro1, closeTo(0.8, 1e-9));
      expect(engine.macro2, closeTo(0.0, 1e-9));
      expect(engine.macro3, closeTo(0.45, 1e-9));
      expect(engine.macro4, closeTo(1.0, 1e-9));
      ...
      expect(engine.activePreset?.parameters['macroOne'], closeTo(0.8, 1e-9));
      expect(engine.activePreset?.parameters['macroB'], closeTo(0.0, 1e-9));
      expect(engine.activePreset?.parameters['macroThree'], closeTo(0.45, 1e-9));
      expect(engine.activePreset?.parameters['macro4'], closeTo(1.0, 1e-9));
